...
<head>
  ...
  <link rel="stylesheet" href="{{URL::asset('assets/template/css/bootstrap.css')}}">
...
<body>
      ...
      <div class="row d-flex justify-content-center">
        <div class="menu-content pb-70 col-lg-8">
          <div class="title text-center">
            ...
            <p>Setia merawat dan menyayangi peliharaan dikala anda sedang sibuk bekerja.</p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="sigle-service col-lg-6 col-md-6">
          ...
          <p>
            ...
            penitipan hewan kesayangan anda.
          </p>
        </div>
        <div class="sigle-service col-lg-6 col-md-6">
    ...
    <div class="container-fluid">
      <div class="row justify-content-end align-items-center d-flex no-padding">
        <div class="col-lg-6 about-left mt-70">
          <h1>We can be solution for your Lonely Pet</h1>
          <p>
            inappropriate behavior is often laughed off as “boys will be <br> boys,” women face higher conduct standards
            especially <br> in the workplace. That’s why it’s crucial that, as women, our <br> behavior on the job is
            beyond reproach.
          </p>
        </div>
        <div class="col-lg-6 about-right">
          <img class="img-fluid" src="image/dog.png" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <footer class="footer-area section-gap">
    <div class="container">
      ...
      <div class="row footer-bottom d-flex justify-content-between">
        ...
        <p class="col-lg-8 col-sm-12 footer-text m-0 text-white">Copyright &copy;<script>
  ...
  <script src="{{URL::asset('assets/template/js/vendor/jquery-2.2.4.min.js')}}"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js"
    integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous">
  </script>
  <script src="{{URL::asset('assets/template/js/vendor/bootstrap.min.js')}}"></script>
  <script src="{{URL::asset('assets/template/js/jquery.ajaxchimp.min.js')}}"></script>
  <script src="{{URL::asset('assets/template/js/parallax.min.js')}}"></script>
  <script src="{{URL::asset('assets/template/js/owl.carousel.min.js')}}"></script>
  <script src="{{URL::asset('assets/template/js/jquery.sticky.js')}}"></script>
  <script src="{{URL::asset('assets/template/js/jquery.DonutWidget.min.js')}}"></script>
  <script src="{{URL::asset('assets/template/js/jquery.magnific-popup.min.js')}}"></script>
